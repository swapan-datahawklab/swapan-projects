...
public class Example {
    ...
    @Command(name = "nested", mixinStandardHelpOptions = true, subcommands = {CommandLine.HelpCommand.class},description = "Hosts more sub-subcommands")
    static class Nested implements Runnable {
        ...
        @Command(mixinStandardHelpOptions = true, subcommands = {CommandLine.HelpCommand.class},description = "Multiplies two numbers.")
        public void multiply(@Option(names = {"-l", "--left"}, required = true) int left, @Option(names = {"-r", "--right"}, required = true) int right) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (Terminal terminal = TerminalBuilder.builder().build()) {
                ...
                widgets.enable();
                KeyMap<Binding> keyMap = reader.getKeyMaps().get("maiSn");
